...
export default function FeatureSectionComponent() {
  return (
    <div className="flex flex-col justify-between md:grid gap-4 md:grid-cols-12 grid-rows-12 h-[1605px] md:h-[1131px] md:w-[689px] md:mx-auto xl:h-[1150px] my-24">
      <div className="col-span-7 row-span-4 col-start-6">
        <ImageComponent
          imageStyles="h-[320px] w-[343px] md:w-[397px] md:h-[367px] xl:w-[635px] xl:h-[400px]"
      ...
      <div className="col-span-7 row-span-6 row-start-5 col-start-1">
        <ImageComponent
          imageStyles="h-[480px] w-[343px] md:w-[398px] md:h-[750px] xl:w-[635px] xl:h-[720px]"
          imageUrl="/desktop/image-grid-2@2x.jpg"
          imageAlt="Grid image two"
        />
      </div>
      <div className="col-span-5 row-span-8 grid grid-rows-8 md:grid-rows-12 ">
        <div className=" row-span-4">
          <ImageComponent
            imageStyles="h-[200px] w-[343px] md:w-[280px] md:h-[367px] xl:w-[445px] xl:h-[313px]"
        ...
        <div className=" row-span-4 row-start-5 md:row-start-7">
          <FeatureTextTileComponent
            tileStyle="md:w-[280px] md:h-[375px] xl:w-[445px] xl:h-[377px]"
            tileDark={true}
